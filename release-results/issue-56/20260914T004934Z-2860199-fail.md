...
| Started UTC | `2026-09-14T00:49:34Z` |
| Finished UTC | `2026-09-14T00:49:46Z` |
...
| Full local log | `/var/log/city-manager-os/releases/issue-56-20260914T004934Z-2860199.log` |
| Full log SHA-256 | `d2ca1606a5369761b9d2b190e05766189f6b41874e445b6b08c9c69adc59ef58` |
...
#56 UNIFIED SPATIAL WATCH PACK
 dashboard/tests/test_spatial_reference_catalog.py | 2 +-
...
full_e2e=yes
unknown=none
[2026-09-14T00:49:35Z] CHANGE-AWARE ACTION: one cached build, Dashboard-only recreation, one n8n restart, no other service restart
2. ONE TARGETED BUILD AND TEST PASS
 Image dashboard-citymanager-dashboard Building 
#37 [26/40] COPY spatial_watch_app.py .
#41 [25/40] COPY spatial_reference_app.py .
 Image dashboard-citymanager-dashboard Built 
 Container dashboard-citymanager-dashboard-run-cfc63d448d9e Creating 
 Container dashboard-citymanager-dashboard-run-cfc63d448d9e Created 
24 passed in 0.32s
 Container dashboard-citymanager-dashboard-run-7e1d87b43318 Creating 
 Container dashboard-citymanager-dashboard-run-7e1d87b43318 Created 
JINJA TARGETED VALIDATION: PASS
Traceback (most recent call last):
[2026-09-14T00:49:45Z] ERROR: command failed rc=1 line=414 phase=targeted-build-test
#56 RELEASE: FAIL rc=1 phase=targeted-build-test line=414
```
